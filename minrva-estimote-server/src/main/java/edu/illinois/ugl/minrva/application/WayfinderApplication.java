 ...
 * <tt>web.xml</tt> file, and is used when Jersey is loaded to determine where
 * Resources are located and to register any binders.
 */
public class WayfinderApplication extends ResourceConfig {
	...
	/**
	 * This is the constructor called directly by unit tests. This allows us to
	 * pass in a mocked version of the dependencies.
	 */
	public WayfinderApplication(final Database database) {
		...
		packages("edu.illinois.ugl.minrva.resources", "com.fasterxml.jackson.jaxrs.json", 
				"edu.illinois.ugl.minrva.authentication");
